...
const FourScreen = () => {
    const data = [
        {
            question: "В каком возрасте лучше делать маммопластику?",
        ...
        {
            question:
                "Безопасно ли ставить имплантаты, если не было беременности и кормления грудью, но планируется?",
        ...
        {
            question:
                "Есть ли срок годности у имплантатов после которого они подлежат замене?",
        ...
        {
            question:
                "Может ли увеличение груди привести к появлению растяжек на коже?",
            answer: "Скорее наоборот, установка имплантатов скрадывает наличие растяжек.",
        },
        {
            question:
                "Можно ли совместить операцию по увеличению груди с коррекцией асимметрии, птоза?",
