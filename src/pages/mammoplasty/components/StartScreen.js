...
const StartScreen = () => {
    return (
        <>
                    ...
                    <GridText item xl={7} lg={7} md={7} sm={7}>
                        <Box sx={{ mt: 14 }}>
                            ...
                            <Text sx={{ fontSize: 32 }} lg={25}>
                                Операция, направленная на коррекцию формы,
                                положения, объема молочных желез
                            </Text>
                        </Box>
                    </GridText>
            ...
            <BoxMobile>
                <Text sx={{ fontSize: 28 }}>Маммопластика</Text>
                <Text sx={{ fontSize: 24, mt: 1 }}>
                    Операция, направленная на коррекцию формы, положения, объема
                    молочных желез
                </Text>
            </BoxMobile>
        </>
