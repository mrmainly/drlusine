...
const ThreeScreen = () => {
    const data = [
        ...
        },
        {
            ...
            text: "Интимная контурная пластика это метод, позволяющий восполнить объем мягких тканей, путем введения препаратов с гиалуроновой кислотой. С помощью интимного филлинга устраняется эстетические, функциональные недостатки, связанные с возрастными изменениями или индивидуальными особенностями организма.",
