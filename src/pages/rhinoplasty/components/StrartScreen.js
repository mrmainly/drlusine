        ...
        <>
                ...
                <Grid container>
                    <GridText item xl={6} lg={7} md={6} sm={7} xs={12}>
                        <Box sx={{ mt: 14 }}>
                            ...
                            <Text sx={{ fontSize: 24 }} lg={25}>
                                Ринопластика – это хирургическая операция по
                                изменению формы носа. Процедура улучшает
                                пропорции лица, устраняет врожденные дефекты и
                                последствия травм.
                            </Text>
                        </Box>
                    </GridText>
            ...
            <BoxMobile>
                ...
                <Text sx={{ fontSize: 24, mt: 1 }}>
                    Ринопластика – это хирургическая операция по изменению формы
                    носа. Процедура улучшает пропорции лица, устраняет
