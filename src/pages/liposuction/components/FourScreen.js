...
const FourScreen = () => {
    const data = [
        {
            question:
                "1) ИМЕЕТЕ ЛИ ВЫ НЕОБХОДИМУЮ КВАЛИФИКАЦИЮ И СЕРТИФИКАЦИЮ ДЛЯ ПРОВЕДЕНИЯ ПОДОБНОЙ ПРОЦЕДУРЫ?",
            answer: "Это – первый вопрос, который задают доктору. Попросите его рассказать о полученном им образовании, повышении квалификации, полученных документах и опыте проведения этой операции. Конечно же, не стоит набрасываться на хирурга с допросами, но полное равнодушие в этом вопросе -это опрометчиво! Опирайтесь на опыт,имеющиеся видимые результаты и отзывы пациентов!",
        },
        {
            question: "2) КАКИЕ ВИДЫ ЛИПОСАКЦИИ СУЩЕСТВУЮТ?",
        ...
        {
            question: "3)Насколько долго сохраняется эффект после липосакции?",
